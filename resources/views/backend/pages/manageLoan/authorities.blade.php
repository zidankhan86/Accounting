...
<div class="col-12 col-md-12 col-lg-12">
    <div class="card">
        ...
        <form action="{{ route('add.authorities.create') }}" method="POST" enctype="multipart/form-data" id="authoritiesForm">
            @csrf
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Authorities Name">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="tel" name="number" class="form-control" id="number" placeholder="Contact Number">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="number" name="cash_limit" id="cash_limit" value="100000"
                            placeholder="100000">
                    ...
                    <div class="form-group col-md-12" style="width: 80%;">
                        ...
                        <textarea name="note" class="form-control" id="note"
                            ...
                            style="font-size: 16px; height: 150px; padding: 10px; resize: vertical;"></textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        submitButton.addEventListener('click', function (event) {
            ...
            axios.post("{{ route('add.authorities.create') }}", formData)
