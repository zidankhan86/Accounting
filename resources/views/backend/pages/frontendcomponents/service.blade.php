...
<div class="col-12 col-md-12 col-lg-12">
    ...
    <div>
        <h6 style="text-align: right;"><i class="fas fa-chevron-right">Our Service </i> <i class="fas fa-chevron-right"> Add Service </i> </h6>
    </div>


    <form  method="POST" enctype="multipart/form-data" id="serviceadd">
  ...
  <script>
    let contactForm = document.getElementById('serviceadd')
